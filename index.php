...
<body>
	...
	<div class="hero-image">
		 ...
		 <img id="image-home" src="images/equality.jpg">

		<div class="hero-text">

			<h1 class ="find-job">Find a job here</h1>
	...
	<div class="container" id="company">
		...
		<div class="company-text">
			...
			<h3 class="leading-companies">with one of these organizations</h3>
		...
		<div class="row" id="companies">
			...
			<img src="" /> <br/>
			<hr>
				Jobs at <a href="#">Government</a>
		</div>

		<div class="box-companies">
			<img src="" /><br/>
			<hr>
				Jobs at <a href="#">NGO</a>
		</div>
